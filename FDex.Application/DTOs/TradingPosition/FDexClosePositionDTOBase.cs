...
{
	[Event("FDexClosePosition")]
	public class FDexClosePositionDTOBase : IEventDTO
	{
        ...
        [Parameter("address", "wallet", 7, false)]
        public virtual string Wallet { get; set; }

        [Parameter("address", "collateralToken", 8, false)]
        public virtual string CollateralToken { get; set; }

        [Parameter("address", "indexToken", 9, false)]
        public virtual string IndexToken { get; set; }

        [Parameter("uint256", "collateralChanged", 10, false)]
        ...
        [Parameter("uint256", "indexPrice", 13, false)]
        public virtual BigInteger IndexPrice { get; set; }

        [Parameter("tuple", "pnl", 14, false)]
        public virtual SignedInt Pnl { get; set; }

        [Parameter("uint256", "feeValue", 15, false)]
